請產生 HoldLot E2E Regression Unit Test。

## Target

- E2E target：`HoldLot`
- Production workflow blocks：`HoldLot`
- External mock boundaries in current evidence：`none required by mapping`

這是 single-block E2E。Main 的 workflow 只包含 HoldLot。
...
Workflow SQL 只描述 HoldLot 的 workflow definition。
...
完成前執行 task context 指定 validator command，並傳入 `--block HoldLot`。

## Planning

優先讀：
1. PROJECT_CONTRACT.md
2. `{MATERIAL_ROOT}/BlockDocs/HoldLot.md`
3. Issues/*
4. DDL/*
5. Scheduler/*
